...
public class SonarIssueReporterExecute {
  ...
  static String debug_path = "C:\\dev\\gitRepos\\_github\\codeql2sonar-maven-plugin\\";
  ...
  public static void main(String[] args) throws IOException, URISyntaxException {
    ...
    */
    final File sarifInputFile = new File(debug_path + "java-analysis.sarif");
    ...
    try (final FileWriter writer = new FileWriter(debug_path + "result.json")) {
